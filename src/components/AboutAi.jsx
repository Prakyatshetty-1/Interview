        ...
        <div className="infoboxleft">
          <div className="uppercontentdivs">
            <div className="statbox">
              ...
              <div className="lowerstatbox">
                ...
                <h1>12+</h1>
                <div className="arrowedcircleforstat">
                  <FaArrowRightLong
                    style={{
                      color: "black",
                      fontSize: "35px",
            ...
            <div className="watchvideo">
              <div className="flexvideoandtext">
              <div className="playvideo">
                <a
                  href="/SaasExplainerVideo.mp4"
                  target="_blank"
              ...
              <h1 className="videoboxtitle">Watch video
                <br/> to know more
              </h1>
              </div>
            </div>
          ...
          <div className="titlecontentdiv">
            ...
            <div className="middletitlecon">
              <h1>future of</h1>
              <button className="buttonforaboutai">Learn More</button>
          ...
          <div className="lowercontentdiv">
            <p>
              Explore next-gen interview intelligence with Askora — an AI voice
              bot built to
              <br />
              simulate real interview pressure. Speak, listen, and respond in
              natural flow.
              <br />
              Askora adapts in real-time using speech tech and context-based
              questioning to
              <br />
